...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/python-bidi-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/python-bidi-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/python-bidi-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/python-bidi-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/python-bidi-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/python-bidi-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `python-bidi` can be installed with:
